...
def test_errors_multivariate_predict_(x, theta, expected):
...
def test_multivariate_predict_(x, theta, expected):
    np.testing.assert_almost_equal(predict_(x, theta), expected)
